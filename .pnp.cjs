...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "packageRegistryData": [\
      ...
      ["ansi-colors-es6", [\
        ["npm:5.0.0", {\
          "packageLocation": "./.yarn/cache/ansi-colors-es6-npm-5.0.0-5a46d83cb1-72fb8aa34b.zip/node_modules/ansi-colors-es6/",\
          "packageDependencies": [\
            ["ansi-colors-es6", "npm:5.0.0"]\
          ],\
          "linkType": "HARD"\
